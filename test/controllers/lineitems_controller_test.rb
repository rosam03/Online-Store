...
class LineitemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lineitem" do
    assert_difference('Lineitem.count') do
      post lineitems_url, params: { lineitem: { belongs_to: @lineitem.belongs_to, price: @lineitem.price, quantity: @lineitem.quantity } }
    end
  ...
  test "should update lineitem" do
    patch lineitem_url(@lineitem), params: { lineitem: { belongs_to: @lineitem.belongs_to, price: @lineitem.price, quantity: @lineitem.quantity } }
